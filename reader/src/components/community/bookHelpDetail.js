...
class BookHelpDetail extends Component {
  ...
  _showMoreItem() {
    ...
    if (
      bookHelp.bookHelpCommentList.length === 0 ||
    ...
    dispatch(
      bookHelpDetailCommentList(
        this.state.id,
        {start: bookHelp.bookHelpCommentList.length, limit: 30},
        false,
        bookHelp.bookHelpCommentList,
      ),
    );
  }
          ...
          <View>
            <View
              ...
              <Image
                ...
                source={
                  bookHelp.bookHelpDetail.author.avatar
                    ? {
                        uri:
                          api.IMG_BASE_URL +
                          bookHelp.bookHelpDetail.author.avatar,
              ...
              <View style={styles.authorBody}>
                <Text style={styles.authorTitle}>
                  {bookHelp.bookHelpDetail.author.nickname}
                </Text>
                <Text style={styles.authorCreateTime}>
                  {dateFormat(bookHelp.bookHelpDetail.created)}
                </Text>
              </View>
            </View>
            <Text style={styles.detailTitle}>
              {bookHelp.bookHelpDetail.title}
            </Text>
            <Text style={styles.detailContent}>
              {bookHelp.bookHelpDetail.content}
            </Text>
    ...
    return (
      <View style={styles.container}>
        ...
        {bookHelp.isLoadingBookHelpCommentList ? (
          ...
          <FlatList
            enableEmptySections={true}
            data={bookHelp.bookHelpCommentList}
