...
export let bookDiscussionList = (params, isFirst, oldList) => {
  return (dispatch) => {
    ...
    return request.get(
      api.COMMUNITY_BOOK_DISCUSSION_LIST,
      params,
      (data) => {
        data.ok
...
export let bookDiscussionDetail = (id) => {
  return (dispatch) => {
    ...
    return request.get(
      api.COMMUNITY_BOOK_DISCUSSION_DETAIL(id),
      null,
      (data) => {
        data.ok
...
export let bookDiscussionDetailCommentBest = (id) => {
  return (dispatch) => {
    return request.get(
      api.COMMUNITY_BOOK_COMMENT_BEST(id),
      null,
      (data) => {
        data.ok
...
export let bookDiscussionDetailCommentList = (id, params, isFirst, oldList) => {
  return (dispatch) => {
    ...
    return request.get(
      api.COMMUNITY_BOOK_DISCUSSION_COMMENT_LIST(id),
      params,
      (data) => {
        data.ok
          ? dispatch(
              getBookDiscussionCommentListSuccess(data.comments, oldList),
            )
